...
class ConfigManager(IConfigManager):
    ...
    PARAM_MAPPING = {
        ...
        'OPENAI_MODERATION_THRESHOLD': 'OPENAI_MODERATION_THRESHOLD',
        'OPENAI_INSTRUCT_PROVIDER_BASE_URI': 'OPENAI_INSTRUCT_PROVIDER_BASE_URI',
        'VLLM_MAX_CONTEXT_LEN': 'VLLM_MAX_CONTEXT_LEN',
        'VLLM_RESPONSE_MODEL': 'VLLM_RESPONSE_MODEL',
        'VLLM_AI_PROVIDER_HOST': 'VLLM_AI_PROVIDER_HOST',
        'VLLM_AI_PROVIDER_PORT': 'VLLM_AI_PROVIDER_PORT',
